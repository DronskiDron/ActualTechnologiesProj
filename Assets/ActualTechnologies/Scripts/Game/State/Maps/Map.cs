...
namespace ActualTechnologies.Game.State.Maps
{
    public class Map
    {
        ...
        public ObservableList<Buildings.BuildingEntityProxy> Buildings { get; } = new();
        ...
        {
            Origin = mapState;
            mapState.Buildings.ForEach(buildingOrigin => Buildings.Add(new Buildings.BuildingEntityProxy(buildingOrigin)));
